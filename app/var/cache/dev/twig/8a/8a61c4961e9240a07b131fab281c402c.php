...
class __TwigTemplate_9b771ca4d70f046df95fd87bcb553d48 extends Template
{
    private $source;
    private $macros = [];
    ...
    <ul>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["genre"]) || array_key_exists("genre", $context) ? $context["genre"] : (function () { throw new RuntimeError('Variable "genre" does not exist.', 8, $this->source); })()), "songs", [], "any", false, false, false, 8));
        foreach ($context['_seq'] as $context["_key"] => $context["song"]) {
            // line 9
            echo "        <li>
            <a href=\"";
            // line 10
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("song.show", ["id" => twig_get_attribute($this->env, $this->source, $context["song"], "id", [], "any", false, false, false, 10), "slug" => twig_get_attribute($this->env, $this->source, $context["song"], "slug", [], "any", false, false, false, 10)]), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return array (  112 => 13,  101 => 10,  98 => 9,  94 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}", "genre/show.html.twig", "/app/templates/genre/show.html.twig");
    }
}
