...
class __TwigTemplate_80ced53ddf9429e55dfb2ddd9ac59dfc extends Template
{
    private $source;
    private $macros = [];
...
<ul class=\"table\">
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["songs"]) || array_key_exists("songs", $context) ? $context["songs"] : (function () { throw new RuntimeError('Variable "songs" does not exist.', 8, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["song"]) {
            // line 9
            echo "        <li>
            ";
            // line 10
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["song"], "title", [], "any", false, false, false, 10), "html", null, true);
            echo "
        </li>
    ";
        }
...
{% endblock %}
", "test/index.html.twig", "/app/templates/test/index.html.twig");
    }
}
